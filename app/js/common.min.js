...
$(document).ready(function(){var i=$("#my-menu").mmenu({extensions:["position-right","theme-dark","fx-menu-fade","fx-panels-none","fx-listitems-slide"]});const e=$("#my-icon"),n=i.data("mmenu");e.on("click",function(){n.open()}),n.bind("open:finish",function(){setTimeout(function(){e.addClass("is-active")},100)}),n.bind("close:finish",function(){setTimeout(function(){e.removeClass("is-active")},100)}),$(".work__lightgallery").lightGallery({}),$(".clients__brandSlider").slick({slidesToShow:6,slidesToScroll:1,dots:!0}),$(".clients__saySlider").slick({slidesToShow:1,slidesToScroll:1})});