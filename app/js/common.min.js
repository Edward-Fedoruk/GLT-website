...
function setUp(){var o=$("#my-menu").mmenu({extensions:["position-right","theme-dark","fx-menu-fade","fx-panels-none","fx-listitems-slide"]});const e=$("#my-icon"),s=o.data("mmenu");e.on("click",function(){s.open()}),s.bind("open:finish",function(){setTimeout(function(){e.addClass("is-active")},100)}),s.bind("close:finish",function(){setTimeout(function(){e.removeClass("is-active")},100)}),$(".work__lightgallery").lightGallery({}),$(".clients__brandSlider").slick({slidesToShow:6,slidesToScroll:1,dots:!0}),$(".clients__saySlider").slick({slidesToShow:1,slidesToScroll:1}),AOS.init({offset:300,duration:700,once:!0})}const addClassOnScroll=(o,e,s)=>l=>{console.log(o,e,s,l),e+o<$(window).scrollTop()?s.addClass(l):s.removeClass(l)};$(document).ready(()=>{setUp();const o=o=>e=>{const s=o||$(e.currentTarget).attr("data-link");$("html, body").animate({scrollTop:$(s).offset().top},500)},e=$(".header__menuWrap"),s=$(".about"),l=$(".scrollTop");$(".header__menuItem").click(o(!1)),$(".mainHeader__scrollIcon").click(o(!1)),l.click(o(".page"));const n=addClassOnScroll(e.height(),e.offset().top,e),i=addClassOnScroll(0,s.offset().top,$(".scrollTop"));$(window).scroll(o=>{n("header__menuWrap-bg"),i("scrollTop-visible")})});