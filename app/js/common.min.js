...
$(document).ready(function(){var n=$("#my-menu").mmenu({extensions:["position-right","theme-dark","fx-menu-fade","fx-panels-none","fx-listitems-slide"]});const i=$("#my-icon"),e=n.data("mmenu");i.on("click",function(){e.open()}),e.bind("open:finish",function(){setTimeout(function(){i.addClass("is-active")},100)}),e.bind("close:finish",function(){setTimeout(function(){i.removeClass("is-active")},100)}),$(".work__lightgallery").lightGallery({})});