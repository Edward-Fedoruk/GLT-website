...
function setMmenu(){var e=$("#my-menu").mmenu({extensions:["position-right","theme-dark","fx-menu-fade","fx-panels-none","fx-listitems-slide"]});const s=$("#my-icon"),o=e.data("mmenu");s.on("click",function(){o.open()}),o.bind("open:finish",function(){setTimeout(function(){s.addClass("is-active")},100)}),o.bind("close:finish",function(){setTimeout(function(){s.removeClass("is-active")},100)})}function setAOS(){AOS.init({offset:300,duration:700,once:!0})}function setLighGallery(){$(".work__lightgallery").lightGallery()}function setSlick(){$(".clients__brandSlider").slick({slidesToShow:6,slidesToScroll:1,dots:!0,responsive:[{breakpoint:900,settings:{slidesToShow:3,infinite:!0,dots:!0}},{breakpoint:600,settings:{slidesToShow:1,infinite:!0,dots:!0,arrows:!1}}]}),$(".clients__saySlider").slick({slidesToShow:1,slidesToScroll:1,responsive:[{breakpoint:600,settings:{slidesToShow:1,infinite:!0,dots:!0,arrows:!1}}]})}const addClassOnScroll=(e,s,o)=>(i,n)=>s+e<n?o.addClass(i):o.removeClass(i),scrollTo=e=>s=>{const o=e||$(s.currentTarget).attr("data-link");$("html, body").animate({scrollTop:$(o).offset().top},500)};$(document).ready(()=>{setMmenu(),setAOS(),setSlick(),setLighGallery();const e=$(".header__menuWrap"),s=$(".about"),o=$(".scrollTop"),i=$(".mainHeader"),n=i.height(),t=addClassOnScroll(e.height(),e.offset().top,e),l=addClassOnScroll(0,s.offset().top,$(".scrollTop"));$(".header__menuItem").click(scrollTo(!1)),$(".mainHeader__scrollIcon").click(scrollTo(!1)),o.click(scrollTo(".page")),$(window).scroll(e=>{const s=e.currentTarget.scrollY;t("header__menuWrap-bg",s),l("scrollTop-visible",s),n>e.currentTarget.scrollY&&i.css("background-position",`0px ${s/2}px`)})});